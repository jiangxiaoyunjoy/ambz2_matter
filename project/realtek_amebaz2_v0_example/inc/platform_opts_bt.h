...
#elif ((defined CONFIG_BLE_MATTER_ADAPTER && CONFIG_BLE_MATTER_ADAPTER) || \
	(defined(CONFIG_BLE_MATTER_SCATTERNET_ADAPTER) && CONFIG_BLE_MATTER_SCATTERNET_ADAPTER))// this is defined in application.is.matter.mk
...
#if (!CONFIG_BT_MATTER_ADAPTER && !CONFIG_BLE_MATTER_ADAPTER && !CONFIG_BLE_MATTER_SCATTERNET_ADAPTER && !CONFIG_BT_MESH_DEVICE_MATTER)
