...
*****************************************************************************************
   * @file      ble_matter_scatternet_adapter_app_main.c
...
{
	gap_config_max_le_link_num(BLE_MATTER_SCATTERNET_ADAPTER_APP_MAX_LINKS);
	gap_config_max_le_paired_device(BLE_MATTER_SCATTERNET_ADAPTER_APP_MAX_LINKS);
}
#else
...
void ble_matter_scatternet_adapter_app_le_gap_init(void)
{
	...
	le_register_app_cb(ble_matter_scatternet_adapter_app_gap_callback);
	...
	gatt_register_callback((void *)ble_matter_scatternet_adapter_gap_service_callback);
#endif
...
#if CONFIG_BLE_MATTER_MULTI_ADV
	vendor_cmd_init(ble_matter_scatternet_adapter_app_vendor_callback);
#endif
}
...
{
	ble_matter_scatternet_adapter_app_task_init();
}

int ble_matter_scatternet_adapter_app_main(void)
{
	bt_trace_init();
	ble_matter_scatternet_adapter_bt_stack_config_init();
	bte_init();
	le_gap_init(BLE_MATTER_SCATTERNET_ADAPTER_APP_MAX_LINKS);
	ble_matter_scatternet_adapter_app_le_gap_init();
	ble_matter_scatternet_adapter_app_le_profile_init();
	ble_matter_scatternet_adapter_task_init();
...
int ble_matter_scatternet_adapter_app_init(void)
{
	...
	if (new_state.gap_init_state == GAP_INIT_STATE_STACK_READY) {
		...
		ble_matter_scatternet_adapter_app_main();
	}
...
void ble_matter_scatternet_adapter_app_deinit(void)
{
	...
	ble_matter_scatternet_adapter_app_task_deinit();
