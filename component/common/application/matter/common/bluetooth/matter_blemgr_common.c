#include <platform_opts_bt.h>
	...
	(defined(CONFIG_BLE_MATTER_SCATTERNET_ADAPTER) && CONFIG_BLE_MATTER_SCATTERNET_ADAPTER))
#include "string.h"
#include "gap.h"
#include "gap_le.h"
#include "os_mem.h"
...
#elif (defined(CONFIG_BLE_MATTER_SCATTERNET_ADAPTER) && CONFIG_BLE_MATTER_SCATTERNET_ADAPTER)
extern int ble_matter_scatternet_adapter_peripheral_app_max_links; //app.c
